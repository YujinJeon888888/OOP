...
public  class 동물 implements Playable, Moveable {
	...
	static int numOfAnimals=0;  //전체 동물마다 한개 있는 속성->static//객체마다 다른것이 아닌, 객체가 공유하는 속성
	...
	public 동물(){//생성자
		...
		numOfAnimals++;//동물 생성될 때마다 동물 마리수 ++

	}



	public 동물(String 이름){//매개변수있는 생성자
	...
	public int get나이(){//나이:private->getter setter:private도 접근 가능하게 함.
